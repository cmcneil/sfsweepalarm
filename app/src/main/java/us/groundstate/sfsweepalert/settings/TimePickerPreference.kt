...
class TimePickerPreference(context: Context, attrs: AttributeSet?) : Preference(context, attrs),
    ...
    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        ...
        binding.timePickerDescription.text =
            String.format(
                context.getString(R.string.alert_hour_description),
    ...
    override fun onClick(v: View) {
        ...
        currentHour = sharedPrefs.getString("notification_hour", "11").toString()
        currentMinute = sharedPrefs.getString("notification_minute", "0").toString()
        ...
        val picker =
            MaterialTimePicker.Builder()
                ...
                .setTitleText(context.getString(R.string.alert_hour_name))
                .build()
